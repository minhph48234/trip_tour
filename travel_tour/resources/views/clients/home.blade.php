        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 lg:col-span-3">
                ...
                <form method="GET" action="{{ route('client.tours.search') }}"
                    ...
                    <input type="text" name="keyword" class="w-full border rounded-lg px-3 py-2" placeholder="Tên tour...">

                    <input type="text" name="departure_location" class="w-full border rounded-lg px-3 py-2"
                        placeholder="Điểm khởi hành">

                    <input type="text" name="destination" class="w-full border rounded-lg px-3 py-2"
                    ...
                    <select name="price" class="w-full border rounded-lg px-3 py-2">
